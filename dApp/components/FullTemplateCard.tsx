...
const FullTemplateCard = ({templateId}: Props) => {
  ...
  const writeButton = () => {
    if (error) {
      ...
      const approveText = enough ? 'USDC Approved' : `Allow CloudX to spend USDC`;
    ...
    if (unknownError) {
      ...
      return <>
        ...
        <div className="mt-5 text-center">
          Payments are made with USDC
          (<a className="text-sm" target="_blank"
              href="https://explorer-devnet-algorand-rollup.a1.milkomeda.com/token/0x9ED133F814534B89c530909b9EfBAf226e6C9A4f">0x9ED133F814534B89c530909b9EfBAf226e6C9A4f</a>)
