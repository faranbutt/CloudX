    ...
    <div className="z-50 px-10 py-3">
      <nav className="layout flex container mx-auto">
        <div className="flex-1">
          ...
          <Link className="text-2xl" href="/portal"><Image src={'/logo.png'} width="50" height="35" alt="home link"
                                                           className="inline-block"/></Link>
          <Link className="ml-10" target="_blank" href="https://docs.cloudx.xyz">Docs</Link>
        </div>
